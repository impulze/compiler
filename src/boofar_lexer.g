...
fragment ESCAPE : '\\' ('\r'|'\n'|'\t'|'\b'|'\f'|'\"'|'\\'|'\'');
// taken from http://www.regular-expressions.info/posixbrackets.html
// 5 byte letters not supported by antlr
fragment UNICODE_LETTER : UNICODE_CLASS_LL|UNICODE_CLASS_LT|UNICODE_CLASS_LU;
